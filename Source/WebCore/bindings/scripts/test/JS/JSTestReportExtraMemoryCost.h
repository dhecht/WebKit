...
public:
    ...
    static JSTestReportExtraMemoryCost* create(JSC::Structure*, JSDOMGlobalObject*, Ref<TestReportExtraMemoryCost>&&);
...
{
    static NeverDestroyed<JSTestReportExtraMemoryCostOwner> owner;
    return &owner.get();
}

inline void* wrapperKey(TestReportExtraMemoryCost* wrappableObject)
{
