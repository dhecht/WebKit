...
JSC::Mutator::IsoSubspace* JSTestNamedSetterNoIdentifier::subspaceForImpl(JSC::VM& vm)
{
...
void JSTestNamedSetterNoIdentifierOwner::finalize(JSC::Handle<JSC::Unknown> handle, void* context)
{
    ...
    uncacheWrapper(world, protect(jsTestNamedSetterNoIdentifier->wrapped()).ptr(), jsTestNamedSetterNoIdentifier);
}
