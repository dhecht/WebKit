...
public:
    ...
    static JSExposedToWorkerAndWindow* create(JSC::Structure*, JSDOMGlobalObject*, Ref<ExposedToWorkerAndWindow>&&);
...
{
    static NeverDestroyed<JSExposedToWorkerAndWindowOwner> owner;
    return &owner.get();
}

inline void* wrapperKey(ExposedToWorkerAndWindow* wrappableObject)
{
