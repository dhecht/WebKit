...
JSC::Mutator::IsoSubspace* JSTestNamedSetterWithIndexedGetterAndSetter::subspaceForImpl(JSC::VM& vm)
{
...
void JSTestNamedSetterWithIndexedGetterAndSetterOwner::finalize(JSC::Handle<JSC::Unknown> handle, void* context)
{
    ...
    uncacheWrapper(world, protect(jsTestNamedSetterWithIndexedGetterAndSetter->wrapped()).ptr(), jsTestNamedSetterWithIndexedGetterAndSetter);
}
