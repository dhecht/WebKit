...
JSC::Mutator::IsoSubspace* JSTestStringifierOperationImplementedAs::subspaceForImpl(JSC::VM& vm)
{
...
void JSTestStringifierOperationImplementedAsOwner::finalize(JSC::Handle<JSC::Unknown> handle, void* context)
{
    ...
    uncacheWrapper(world, protect(jsTestStringifierOperationImplementedAs->wrapped()).ptr(), jsTestStringifierOperationImplementedAs);
}
