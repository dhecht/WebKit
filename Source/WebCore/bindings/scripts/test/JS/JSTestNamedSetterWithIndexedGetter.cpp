...
JSC::Mutator::IsoSubspace* JSTestNamedSetterWithIndexedGetter::subspaceForImpl(JSC::VM& vm)
{
...
void JSTestNamedSetterWithIndexedGetterOwner::finalize(JSC::Handle<JSC::Unknown> handle, void* context)
{
    ...
    uncacheWrapper(world, protect(jsTestNamedSetterWithIndexedGetter->wrapped()).ptr(), jsTestNamedSetterWithIndexedGetter);
}
