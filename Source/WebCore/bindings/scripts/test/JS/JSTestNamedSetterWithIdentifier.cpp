...
JSC::Mutator::IsoSubspace* JSTestNamedSetterWithIdentifier::subspaceForImpl(JSC::VM& vm)
{
...
void JSTestNamedSetterWithIdentifierOwner::finalize(JSC::Handle<JSC::Unknown> handle, void* context)
{
    ...
    uncacheWrapper(world, protect(jsTestNamedSetterWithIdentifier->wrapped()).ptr(), jsTestNamedSetterWithIdentifier);
}
