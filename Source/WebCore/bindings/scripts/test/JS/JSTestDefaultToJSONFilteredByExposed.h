...
public:
    ...
    static TestDefaultToJSONFilteredByExposed* toWrapped(JSC::VM&, JSC::JSValue);
...
{
    static NeverDestroyed<JSTestDefaultToJSONFilteredByExposedOwner> owner;
    return &owner.get();
}

inline void* wrapperKey(TestDefaultToJSONFilteredByExposed* wrappableObject)
{
