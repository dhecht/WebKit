...
public:
    ...
    static TestReadOnlySetLike* toWrapped(JSC::VM&, JSC::JSValue);
...
{
    static NeverDestroyed<JSTestReadOnlySetLikeOwner> owner;
    return &owner.get();
}

inline void* wrapperKey(TestReadOnlySetLike* wrappableObject)
{
