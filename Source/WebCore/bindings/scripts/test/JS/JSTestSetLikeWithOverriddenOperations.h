...
public:
    ...
    static JSTestSetLikeWithOverriddenOperations* create(JSC::Structure*, JSDOMGlobalObject*, Ref<TestSetLikeWithOverriddenOperations>&&);
...
{
    static NeverDestroyed<JSTestSetLikeWithOverriddenOperationsOwner> owner;
    return &owner.get();
}

inline void* wrapperKey(TestSetLikeWithOverriddenOperations* wrappableObject)
{
