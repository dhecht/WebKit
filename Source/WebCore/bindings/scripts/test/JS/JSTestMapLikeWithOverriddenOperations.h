...
public:
    ...
    static JSTestMapLikeWithOverriddenOperations* create(JSC::Structure*, JSDOMGlobalObject*, Ref<TestMapLikeWithOverriddenOperations>&&);
...
{
    static NeverDestroyed<JSTestMapLikeWithOverriddenOperationsOwner> owner;
    return &owner.get();
}

inline void* wrapperKey(TestMapLikeWithOverriddenOperations* wrappableObject)
{
