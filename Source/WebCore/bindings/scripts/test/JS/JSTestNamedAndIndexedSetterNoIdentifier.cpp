...
JSC::Mutator::IsoSubspace* JSTestNamedAndIndexedSetterNoIdentifier::subspaceForImpl(JSC::VM& vm)
{
...
void JSTestNamedAndIndexedSetterNoIdentifierOwner::finalize(JSC::Handle<JSC::Unknown> handle, void* context)
{
    ...
    uncacheWrapper(world, protect(jsTestNamedAndIndexedSetterNoIdentifier->wrapped()).ptr(), jsTestNamedAndIndexedSetterNoIdentifier);
}
