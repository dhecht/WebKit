...
public:
    ...
    static JSTestMapLike* create(JSC::Structure*, JSDOMGlobalObject*, Ref<TestMapLike>&&);
...
{
    static NeverDestroyed<JSTestMapLikeOwner> owner;
    return &owner.get();
}

inline void* wrapperKey(TestMapLike* wrappableObject)
{
