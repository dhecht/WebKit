...
JSC::Mutator::IsoSubspace* JSTestStringifierNamedOperation::subspaceForImpl(JSC::VM& vm)
{
...
void JSTestStringifierNamedOperationOwner::finalize(JSC::Handle<JSC::Unknown> handle, void* context)
{
    ...
    uncacheWrapper(world, protect(jsTestStringifierNamedOperation->wrapped()).ptr(), jsTestStringifierNamedOperation);
}
